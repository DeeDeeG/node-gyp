...
PythonFinder.prototype = {
  ...
  // being in the $PATH.
  // The Python launcher supports all versions of Python, but we can
  ...
  checkPyLauncher: function checkPyLauncher (flag, errorCallback) {
    this.log.verbose(
      `- executing "${this.pyLauncher}" to get Python executable path`)
    this.run(this.pyLauncher, [flag, ...this.argsExecutable], false,
