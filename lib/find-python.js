...
// globalErrorLog is only added to by functions defined outside of PythonFinder.
// This can only be modified before PythonFinder.prototype.findPython's
// assignment is evaluated. Changes after that won't be printed during errors.
...
function getWinDefaultLocations () {
  ...
  function getOsUserInfo () {
    try {
      ...
      globalAddLog('Warning: unable to get username via os.userInfo().username. Proceeding anyway.')
      globalAddLog(err.stack)
    }
  }

  // A global version of PythonFinder.addLog, for use outside of PythonFinder
