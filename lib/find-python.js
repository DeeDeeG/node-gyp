...
PythonFinder.prototype = {
  ...
  pyLauncher: 'py.exe',
  winDefaultLocations: [
    path.join(process.env.SystemDrive || 'C:', 'Users', process.env.USERNAME, 'AppData', 'Local', 'Programs', 'Python', 'Python39', 'python.exe'),
    path.join(process.env.SystemDrive || 'C:', 'Users', process.env.USERNAME, 'AppData', 'Local', 'Programs', 'Python', 'Python38', 'python.exe'),
    path.join(process.env.SystemDrive || 'C:', 'Users', process.env.USERNAME, 'AppData', 'Local', 'Programs', 'Python', 'Python37', 'python.exe'),
    path.join(process.env.SystemDrive || 'C:', 'Users', process.env.USERNAME, 'AppData', 'Local', 'Programs', 'Python', 'Python36', 'python.exe'),
    ...
    path.join(process.env.SystemDrive || 'C:', 'Users', process.env.USERNAME, 'AppData', 'Local', 'Programs', 'Python', 'Python39-32', 'python.exe'),
    path.join(process.env.SystemDrive || 'C:', 'Users', process.env.USERNAME, 'AppData', 'Local', 'Programs', 'Python', 'Python38-32', 'python.exe'),
    path.join(process.env.SystemDrive || 'C:', 'Users', process.env.USERNAME, 'AppData', 'Local', 'Programs', 'Python', 'Python37-32', 'python.exe'),
    path.join(process.env.SystemDrive || 'C:', 'Users', process.env.USERNAME, 'AppData', 'Local', 'Programs', 'Python', 'Python36-32', 'python.exe'),
